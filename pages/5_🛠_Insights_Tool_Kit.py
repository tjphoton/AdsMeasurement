...
st.sidebar.header("Insights Tool Kit")

st.title("Insights Tool Kit")

# tab1, tab2, tab3, tab4 = st.tabs(["Effect (What happened?)",
#                                     "Causality (Why happened?)",
#                                     "Counterfactual (What if?)",
#                                     "Forecasting (What next?)"])
...
with st.expander("Effect (What happened?)"):
...
with st.expander("Causality (Why happened?)"):
    st.header("Causality")
    # st.image("https://static.streamlit.io/examples/dog.jpg", width=200)

with st.expander("Counterfactual (What if?)"):
    st.header("Counterfactual")
    # st.image("https://static.streamlit.io/examples/owl.jpg", width=200)

with st.expander("Forecasting (What next?)"):
    st.header("Forecasting")
    # st.image("https://static.streamlit.io/examples/owl.jpg", width=200)

# st.markdown("#### Effect (What happened?)")
# st.markdown("#### Causality (Why happened?)")
# st.markdown("#### Counterfactual (What if?)")
# st.markdown("#### Forecasting (What next?)")
